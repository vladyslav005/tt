...
export function TyConstructorAppFlowNode({selected}: { data: TypeNodeData; selected?: boolean }) {
  return (
    <div className={cn(
      ...
      <div className="px-4 pt-4 pb-3 flex items-center gap-2 border-b border-teal-500/15">
        <span className="text-sm font-bold text-teal-600 dark:text-teal-400">F T</span>
        <span className="text-xs font-semibold text-teal-600 dark:text-teal-400">Type Constructor Application</span>
      </div>
      ...
      <div className="p-4 grid grid-cols-2 gap-3">
        <div className="relative flex flex-col items-center gap-1 rounded-lg border border-teal-200 dark:border-teal-800 bg-background/50 px-3 py-3">
          <span className="text-xs font-medium text-teal-600 dark:text-teal-400">func</span>
        ...
        <div className="relative flex flex-col items-center gap-1 rounded-lg border border-teal-200 dark:border-teal-800 bg-background/50 px-3 py-3">
          <span className="text-xs font-medium text-teal-600 dark:text-teal-400">arg</span>
