...
import type {UnfoldNodeData} from "@/shared/presentation/flow/types.ts";
import {cn} from "@/shared/lib/utils";
import {LimitedHandle} from "./LimitedHandle.tsx";

export function UnfoldFlowNode({selected}: { data: UnfoldNodeData; selected?: boolean }) {
  return (
    <div className={cn(
      ...
      <div className="px-4 pt-4 pb-3 flex items-center gap-2 border-b border-green-500/15">
        <span className="text-sm font-bold text-green-600 dark:text-green-400">unfold</span>
        <span className="text-xs font-semibold text-green-600 dark:text-green-400">Out of μ</span>
      </div>
