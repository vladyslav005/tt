...
export function StlcBasicsLecture() {
  return (
    <motion.div initial="initial" animate="animate" variants={staggerContainer} className="space-y-12">
      ...
      <motion.div variants={fadeInUp}>
        <SectionHeading index="0" title="Why any of this?" blurb="A minute of context before the formalism starts."/>
      </motion.div>

      <motion.div variants={fadeInUp}>
        <ConceptSection title="What does &quot;STLC&quot; even mean?">
          <p>
      ...
      <motion.div variants={fadeInUp}>
        <ConceptSection title="Types and grammars, in plain terms">
          <ul className="list-disc pl-5 space-y-1.5">
            <li>
      ...
      <motion.div variants={fadeInUp}>
        <ConceptSection title="Where this comes from">
          <p>
          ...
          <p>
            ...
            out to define the exact same thing, and Church's is the one this lecture teaches.
          </p>
          <p>
            That's not just trivia. The question this lecture keeps asking — "does this term
            make sense?" — is the same one TypeScript, Rust, or Java answers before your code
            ever runs. Learn to answer it by hand once, and a type error stops looking like a
            wall and starts looking like a rule you can point to.
          </p>
        </ConceptSection>
      </motion.div>
      ...
      {/* ---------------------------------------------------------------- SYNTAX ---------- */}
      <motion.div variants={fadeInUp}>
        <SectionHeading index="1" title="Syntax" blurb="What does a term look like, and what's its shape underneath?"/>
      </motion.div>

      <motion.div variants={fadeInUp}>
        <ConceptSection title="Terms">
          <p>
      ...
      <motion.div variants={fadeInUp}>
        <ConceptSection title="The arrow: how a function's type is written">
          <p>
      ...
      <motion.div variants={fadeInUp}>
        <ConceptSection title="From text to tree">
          <p>
      ...
      <motion.div variants={fadeInUp}>
        <ConceptSection title="Names: free vs. bound">
          <p>
      ...
      <motion.div variants={fadeInUp}>
        <ConceptSection title="α-equivalence: names don't matter, bindings do">
          <p>
      ...
      {/* ---------------------------------------------------------------- TYPING ---------- */}
      <motion.div variants={fadeInUp}>
        <SectionHeading index="2" title="Typing" blurb="Given the shape above, does this particular term make sense?"/>
      </motion.div>

      <motion.div variants={fadeInUp}>
        <ConceptSection title="Why bother?">
          <p>
      ...
      <motion.div variants={fadeInUp}>
        <ConceptSection title="How to read a typing rule">
          <p>
      ...
      <motion.div variants={fadeInUp}>
        <RuleCardStrip ruleIds={["T-Var", "T-Abs", "T-App", "T-Const", "T-If"]}/>
      </motion.div>
      ...
      {/* -------------------------------------------------------------- SEMANTICS ---------- */}
      <motion.div variants={fadeInUp}>
        <SectionHeading index="3" title="Semantics" blurb="The term type-checks — now what does it actually do when it runs?"/>
      </motion.div>

      <motion.div variants={fadeInUp}>
        <ConceptSection title="The same idea as ordinary functions">
      ...
      <motion.div variants={fadeInUp}>
        <ConceptSection title="Substitution, precisely">
          <p>
      ...
      <motion.div variants={fadeInUp}>
        <ConceptSection title="What an evaluation rule means">
          <p>
      ...
      <motion.div variants={fadeInUp}>
        <ConceptSection title="Evaluation strategies: which redex first?">
          <p>
      ...
      <motion.div variants={fadeInUp}>
        <ConceptSection title="When evaluation never stops">
          <p>
      ...
      <motion.div variants={fadeInUp}>
        <ConceptSection title="Does the order ever change the answer?">
          <p>
