...
export function SumTypeFlowNode({selected}: { data: TypeNodeData; selected?: boolean }) {
  return (
    <div className={cn(
      ...
      <div className="px-4 pt-4 pb-3 flex items-center gap-2 border-b border-slate-500/15">
        ...
        <span className="text-xs font-semibold text-slate-600 dark:text-slate-400">Sum Type</span>
      </div>

      <div className="p-4 grid grid-cols-2 gap-3">
        <div className="relative flex flex-col items-center gap-1 rounded-lg border border-slate-200 dark:border-slate-800 bg-background/50 px-3 py-3">
